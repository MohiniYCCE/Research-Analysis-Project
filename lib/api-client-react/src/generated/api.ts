...
export const getGetDatasetsSummaryQueryKey = () => {
  return [`/api/datasets/summary`] as const;
};

export const getGetDatasetsSummaryQueryOptions = <
  TData = Awaited<ReturnType<typeof getDatasetsSummary>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
    Awaited<ReturnType<typeof getDatasetsSummary>>,
    TError,
    TData
  >;
  request?: SecondParameter<typeof customFetch>;
  ...
  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getDatasetsSummary>>
  > = ({ signal }) => getDatasetsSummary({ signal, ...requestOptions });
...
export type GetDatasetsSummaryQueryResult = NonNullable<
  Awaited<ReturnType<typeof getDatasetsSummary>>
>;
...
export function useGetDatasetsSummary<
  TData = Awaited<ReturnType<typeof getDatasetsSummary>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
 ...
 */
export const getGetStreamlitUrlUrl = () => {
  return `/api/streamlit-url`;
};

export const getStreamlitUrl = async (
  options?: RequestInit,
): Promise<StreamlitUrlResponse> => {
  return customFetch<StreamlitUrlResponse>(getGetStreamlitUrlUrl(), {
    ...options,
    method: "GET",
  });
};

export const getGetStreamlitUrlQueryKey = () => {
  return [`/api/streamlit-url`] as const;
};

export const getGetStreamlitUrlQueryOptions = <
  TData = Awaited<ReturnType<typeof getStreamlitUrl>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
    Awaited<ReturnType<typeof getStreamlitUrl>>,
    TError,
    TData
  >;
  request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey = queryOptions?.queryKey ?? getGetStreamlitUrlQueryKey();

  const queryFn: QueryFunction<Awaited<ReturnType<typeof getStreamlitUrl>>> = ({
    signal,
  }) => getStreamlitUrl({ signal, ...requestOptions });
...
export type GetStreamlitUrlQueryResult = NonNullable<
  Awaited<ReturnType<typeof getStreamlitUrl>>
>;
export type GetStreamlitUrlQueryError = ErrorType<unknown>;

/**
 * @summary Get Streamlit server URL for analytics embedding
 */

export function useGetStreamlitUrl<
  TData = Awaited<ReturnType<typeof getStreamlitUrl>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
  ...
  const queryOptions = getGetStreamlitUrlQueryOptions(options);
